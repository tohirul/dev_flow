...
const badgeVariants = cva(
  'inline-flex items-center px-2.5 py-0.5 border border-slate-200 dark:border-slate-800 rounded-md focus:outline-none focus:ring-2 focus:ring-slate-950 dark:focus:ring-slate-300 focus:ring-offset-2 font-semibold text-xs transition-colors',
  {
    variants: {
      variant: {
        default:
